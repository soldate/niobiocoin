...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 8432);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 18432);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 48432);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 38432);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 18543);
    }
    assert(false);
}
